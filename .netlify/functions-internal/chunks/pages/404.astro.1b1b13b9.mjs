    ...
    <div class="row g-5">
      <div class="col-lg-3 col-md-6">
        ...
        <p class="mb-2">
          ...
          <a style="color:#fff" href="mailto:reserve@prestigeworldwidelimos.com" target="_blank">Email</a>
        </p>
  ...
  <div class="row align-items-center top-bar">
    ...
    <div class="col-lg-9 col-md-12 text-end">
      ...
      <div class="h-100 d-inline-flex align-items-center me-4">
        ...
        <p class="m-0" style="font-size:16px; font-weight:600 ;">
          <a href="mailto:frankie@prestigeworldwidelimos.com" target="_blank">Email</a>
        </p>
      </div>
