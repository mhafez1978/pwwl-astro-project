    ...
    <div class="row g-5 astro-SZ7XMLTE">
      <div class="col-lg-3 col-md-6 astro-SZ7XMLTE">
        ...
        <p class="mb-2 astro-SZ7XMLTE">
          ...
          Address: <br class="astro-SZ7XMLTE">1515 Spruce Lane Denver, NC 28037 USA
        </p>
        <p class="mb-2 astro-SZ7XMLTE">
      ...
      <div class="col-lg-3 col-md-6 astro-SZ7XMLTE">
        ...
        <div class="position-relative mx-auto astro-SZ7XMLTE" style="max-width: 400px;">
          ${renderComponent($$result, "NewsletterSignup", NewsletterSignup, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/mhafez/Desktop/My Portfolio (Node & React)/New GitHub/ASTRO/friday-astro/src/components/NewsletterSignup", "client:component-export": "default", "class": "astro-SZ7XMLTE" })}
        </div>
      </div>
    </div>
  </div>
