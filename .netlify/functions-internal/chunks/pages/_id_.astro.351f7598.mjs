...
import { $ as $$Footer, a as $$Navbar, b as $$Topbar } from './404.astro.a46cb527.mjs';
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<div class="container" style="margin:100px auto; display:flex;flex-direction: column; justify-content:center; align-items:center">
    <img${addAttribute(900, "width")}${addAttribute(400, "height")}${addAttribute(hasFeaturedMedia ? postMedia._embedded["wp:featuredmedia"]["0"].media_details.sizes.full.source_url : "https://img.freepik.com/free-vector/hand-painted-watercolor-pastel-sky-background_23-2148902771.jpg", "src")} style="width: 72vw; height:30vh">
