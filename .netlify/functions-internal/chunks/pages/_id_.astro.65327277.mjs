import { c as createAstro, a as createComponent, r as renderTemplate, b as renderComponent, e as renderSlot, f as renderHead, d as addAttribute, m as maybeRenderHead, u as unescapeHTML } from '../astro.a5318bb2.mjs';
import { $ as $$Footer, a as $$Navbar, b as $$Topbar } from './404.astro.1a2f991a.mjs';
...
}, "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/layouts/LandingLayout.astro", void 0);
...
}, "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/components/ToTop.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<div class="container" style="margin:100px auto; display:flex;flex-direction: column; justify-content:center; align-items:center">
    <img${addAttribute(900, "width")}${addAttribute(800, "height")}${addAttribute(hasFeaturedMedia ? postMedia._embedded["wp:featuredmedia"]["0"].media_details.sizes.full.source_url : "https://img.freepik.com/free-vector/hand-painted-watercolor-pastel-sky-background_23-2148902771.jpg", "src")} style="width: 72vw; height:60vh">
...
` })}`;
}, "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/pages/posts/[id].astro", void 0);

const $$file = "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/pages/posts/[id].astro";
const $$url = "/posts/[id]";
