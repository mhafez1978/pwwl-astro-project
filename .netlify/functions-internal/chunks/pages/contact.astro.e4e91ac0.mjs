import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, _ as __astro_tag_component__, b as renderComponent } from '../astro.9e971bc7.mjs';
...
const $$Contact = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="container mx-auto">
    <div class="row">
      <div class="col-lg-6">
        <img src="https://prestigeworldwidelimos.com/carolina-limo-rentals/wp-content/uploads/2022/12/pwwl-dark-logo.png" alt="logo" width="200" style="margin-bottom:40px;">
...
export { $$Spinner as $, ContactForm as C, $$ToTop as a, contact as c };
