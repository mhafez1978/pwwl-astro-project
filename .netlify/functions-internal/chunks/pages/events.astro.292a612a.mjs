...
const EventList = () => {
  ...
  useEffect(() => {
    const fetchEventsGeoIp = async () => {
      try {
        const response2 = await fetch(`https://api.seatgeek.com/2/events?geoip=true&range=40mi&client_id=MzUxNTA5MTl8MTY5MDI1MzI4MS44NTI1NDM4&page=${currentPage}`);
...
const $$Events = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Events;
  return renderTemplate`${renderComponent($$result, "LandingLayout", $$LandingLayout, { "pageTitle": "Local Events 4 You", "pageDescription": "Local Events in Your Area", "pageKeywords": "Local Events in Your Area", "class": "astro-RO7PGS3H" }, { "default": ($$result2) => renderTemplate`
  ...
  ${maybeRenderHead()}<div class="container-fluid astro-RO7PGS3H" style="margin-top:100px; min-height:100vh;z-index:-1;">
    <div style="width:86vw;margin:0 auto;" class="astro-RO7PGS3H">
      <div style="display:flex;flex-direction:column;justify-content: center;align-items: center; margin-bottom: 40px;" class="astro-RO7PGS3H">
        <center class="astro-RO7PGS3H"><h1 style="color:#FF4917" class="astro-RO7PGS3H">Local Events</h1></center>
      ...
      ${renderComponent($$result2, "EventsPagination", EventList, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/components/EventsPagination", "client:component-export": "default", "class": "astro-RO7PGS3H" })}
    </div>
  </div>
  ${renderComponent($$result2, "ToTop", $$ToTop, { "class": "astro-RO7PGS3H" })}
` })}`;
}, "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/pages/events.astro", void 0);

const $$file = "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/pages/events.astro";
const $$url = "/events";
