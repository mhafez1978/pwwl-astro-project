...
import { C as ContactForm, $ as $$Spinner } from './contact.astro.a03a386c.mjs';
...
const $$Carousel = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="owl-carousel header-carousel position-relative astro-WFE7XCNO">
    ...
    <div class="owl-carousel-item position-relative astro-WFE7XCNO" style="height:85vh">
      ${renderComponent($$result, "Picture", $$Picture, { "src": "/assets/img/white-diamond-party-bus.jpg", "widths": [200, 400, 800], "sizes": "(max-width: 800px) 100vw, 800px", "alt": "descriptive text", "aspectRatio": "16:9", "class": "astro-WFE7XCNO" })}
      <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center astro-WFE7XCNO" style="background: rgba(0, 0, 0, 0.4)">
        <div class="container astro-WFE7XCNO">
          <div class="row justify-content-start astro-WFE7XCNO">
            <div class="col-10 col-lg-8 astro-WFE7XCNO">
    ...
    <div class="owl-carousel-item position-relative astro-WFE7XCNO" style="height:85vh">
      ${renderComponent($$result, "Picture", $$Picture, { "src": "/assets/img/space-theme-party-bus.jpg", "widths": [200, 400, 800], "sizes": "(max-width: 800px) 100vw, 800px", "alt": "descriptive text", "aspectRatio": "16:9", "class": "astro-WFE7XCNO" })}
      <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center astro-WFE7XCNO" style="background: rgba(0, 0, 0, 0.4)">
        <div class="container astro-WFE7XCNO">
          <div class="row justify-content-start astro-WFE7XCNO">
            <div class="col-10 col-lg-8 astro-WFE7XCNO">
...
const $$Service = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="container">
    <div class="row">
      <center>
        <h1>Luxury Limo Near Charlotte, North Carolina</h1>
      </center>
      <p class="text-center" style="font-size: 16px;">
        Prestige Worldwide Limo Company is as close as a phone call. If you need
        professional transportation, wedding limousine, charter bus,<br> group
    ...
    <div class="row g-4" style="margin-top: 80px;">
      <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div class="d-flex align-items-center justify-content-between bg-light p-4">
          <h5 class="text-truncate me-3 mb-0">Wedding Limo</h5>
          <!-- <a
      ...
      <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.3s">
        ...
        <div class="d-flex align-items-center justify-content-between bg-light p-4">
          <h5 class="text-truncate me-3 mb-0">Charter Bus</h5>
          <!-- <a
            class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0"
            href=""><i class="fa fa-arrow-right"></i></a
          > -->
      ...
      <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.5s">
        ...
        <div class="d-flex align-items-center justify-content-between bg-light p-4">
          <h5 class="text-truncate me-3 mb-0">Charlotte Party Bus</h5>
          <!-- <a
            class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0"
            href=""><i class="fa fa-arrow-right"></i></a
          > -->
  ...
  <div class="container mt-4">
    <div class="row g-4">
      <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div class="d-flex align-items-center justify-content-between bg-light p-4">
          <h5 class="text-truncate me-3 mb-0">Prom Night Limo</h5>
          <!-- <a
            class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0"
            href=""><i class="fa fa-arrow-right"></i></a
          > -->
      ...
      <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.3s">
        ...
        <div class="d-flex align-items-center justify-content-between bg-light p-4">
          <h5 class="text-truncate me-3 mb-0">Airport Limo</h5>
          <!-- <a
            class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0"
            href=""><i class="fa fa-arrow-right"></i></a
          > -->
      ...
      <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.5s">
        ...
        <div class="d-flex align-items-center justify-content-between bg-light p-4">
          <h5 class="text-truncate me-3 mb-0">Wine Tours Limo</h5>
          <!-- <a
            class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0"
            href=""><i class="fa fa-arrow-right"></i></a
          > -->
    ...
    <div class="row g-5 astro-V2CBYR3P">
      ...
      <div class="col-lg-6 pt-4 astro-V2CBYR3P" style="min-height: 500px;">
        <div class="position-relative h-100 wow fadeInUp astro-V2CBYR3P" data-wow-delay="0.5s">
          <img class="position-absolute img-fluid w-100 h-100 astro-V2CBYR3P" src="/assets/img/white-pearl-night-scene.jpg" style="object-fit: cover; padding: 0 0 50px 100px;" alt="">
          <img class="position-absolute start-0 bottom-0 img-fluid bg-white pt-2 pe-2 w-50 h-50 astro-V2CBYR3P" src="/assets/img/frankie2.jpg" style="object-fit: cover;" alt="">
        </div>
      </div>
    </div>
  </div>
...
export { $$Testimonial as $, $$Service as a, $$Booking as b, index as i };
