...
import './events.astro.e6c70164.mjs';
...
/* empty css                            */
const API_URL = `https://api.charlottecitylimo.com/wp-json/wp/v2/posts?_embed&per_page=100`;
const Author_URL = `https://api.charlottecitylimo.com/wp-json/wp/v2/users`;
