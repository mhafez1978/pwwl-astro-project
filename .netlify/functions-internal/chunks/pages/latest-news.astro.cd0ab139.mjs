...
import './events.astro.d21e90e1.mjs';
...
import 'mime';
import 'string-width';
/* empty css                             */import '@emailjs/browser';
/* empty css                            */
...
const $$LatestNews = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<div class="container-fluid astro-KEUWC25X" style="margin-top:100px; min-height:100vh;z-index:-1;">
    <div style="width:86vw;margin:0 auto;" class="astro-KEUWC25X">
      <div style="display:flex;flex-direction:column;justify-content: center;align-items: center; margin-bottom: 40px;" class="astro-KEUWC25X">
        <h1 style="color:#FF4917" class="astro-KEUWC25X">Latest News</h1>
