import { c as createAstro, a as createComponent, r as renderTemplate, b as renderComponent, m as maybeRenderHead } from '../astro.a5318bb2.mjs';
import { $ as $$ToTop, a as $$LandingLayout } from './_id_.astro.65327277.mjs';
import { $ as $$Spinner, C as ContactForm } from './contact.astro.d8d12ce6.mjs';
...
const $$Reserve = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="container astro-56NBFQGZ">
    ...
    <br class="astro-56NBFQGZ">
    ${renderComponent($$result2, "ContactForm", ContactForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/components/ContactForrm", "client:component-export": "default", "class": "astro-56NBFQGZ" })}
  </div>

  ${renderComponent($$result2, "ToTop", $$ToTop, { "class": "astro-56NBFQGZ" })}
` })}`;
}, "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/pages/reserve.astro", void 0);

const $$file = "/Users/mhafez/Desktop/My Portfolio (Node & React)/pwwl-astro-project/src/pages/reserve.astro";
const $$url = "/reserve";
